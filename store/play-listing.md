...
life tracker, no account, gym log, daily planner, screen-free analytics

## Privacy policy URL
https://kishore2494.github.io/daily-pulse/privacy.html

## Data safety form answers
- Data collected: **None**
- Data shared: **None**
- Data encrypted in transit: N/A (no collection)
- Data deletion: user can delete all data in-app / by uninstalling
- Optional features (declare if asked): user-configured sync to user's own
  Google Sheet; optional ntfy.sh push for reminder labels only
